...
/** columns and relationships of "image_processing" */
export type ImageProcessing = {
  __typename?: 'image_processing';
...
/** aggregated selection of "image_processing" */
export type ImageProcessingAggregate = {
  __typename?: 'image_processing_aggregate';
  aggregate?: Maybe<ImageProcessingAggregateFields>;
  nodes: Array<ImageProcessing>;
};

/** aggregate fields of "image_processing" */
export type ImageProcessingAggregateFields = {
  __typename?: 'image_processing_aggregate_fields';
  avg?: Maybe<ImageProcessingAvgFields>;
  count: Scalars['Int'];
  max?: Maybe<ImageProcessingMaxFields>;
  min?: Maybe<ImageProcessingMinFields>;
  stddev?: Maybe<ImageProcessingStddevFields>;
  stddev_pop?: Maybe<ImageProcessingStddevPopFields>;
  stddev_samp?: Maybe<ImageProcessingStddevSampFields>;
  sum?: Maybe<ImageProcessingSumFields>;
  var_pop?: Maybe<ImageProcessingVarPopFields>;
  var_samp?: Maybe<ImageProcessingVarSampFields>;
  variance?: Maybe<ImageProcessingVarianceFields>;
};


/** aggregate fields of "image_processing" */
export type ImageProcessingAggregateFieldsCountArgs = {
  columns?: InputMaybe<Array<ImageProcessingSelectColumn>>;
  distinct?: InputMaybe<Scalars['Boolean']>;
};

/** aggregate avg on columns */
export type ImageProcessingAvgFields = {
  __typename?: 'image_processing_avg_fields';
  status?: Maybe<Scalars['Float']>;
};

/** Boolean expression to filter rows from the table "image_processing". All fields are combined with a logical 'AND'. */
export type ImageProcessingBoolExp = {
  _and?: InputMaybe<Array<ImageProcessingBoolExp>>;
  _not?: InputMaybe<ImageProcessingBoolExp>;
  _or?: InputMaybe<Array<ImageProcessingBoolExp>>;
...
/** unique or primary key constraints on table "image_processing" */
export enum ImageProcessingConstraint {
  /** unique or primary key constraint on columns "id" */
  ImageProcessingPkey = 'image_processing_pkey'
}

/** input type for incrementing numeric columns in table "image_processing" */
export type ImageProcessingIncInput = {
  status?: InputMaybe<Scalars['Int']>;
};

/** input type for inserting data into table "image_processing" */
export type ImageProcessingInsertInput = {
  created_at?: InputMaybe<Scalars['timestamptz']>;
  file_id?: InputMaybe<Scalars['uuid']>;
  id?: InputMaybe<Scalars['uuid']>;
  image?: InputMaybe<FilesObjRelInsertInput>;
  message?: InputMaybe<Scalars['String']>;
  status?: InputMaybe<Scalars['Int']>;
};

/** aggregate max on columns */
export type ImageProcessingMaxFields = {
  __typename?: 'image_processing_max_fields';
...
/** aggregate min on columns */
export type ImageProcessingMinFields = {
  __typename?: 'image_processing_min_fields';
  created_at?: Maybe<Scalars['timestamptz']>;
  file_id?: Maybe<Scalars['uuid']>;
  id?: Maybe<Scalars['uuid']>;
  message?: Maybe<Scalars['String']>;
...
/** response of any mutation on the table "image_processing" */
export type ImageProcessingMutationResponse = {
  __typename?: 'image_processing_mutation_response';
  /** number of rows affected by the mutation */
  affected_rows: Scalars['Int'];
  /** data from the rows affected by the mutation */
  returning: Array<ImageProcessing>;
};

/** on_conflict condition type for table "image_processing" */
export type ImageProcessingOnConflict = {
  constraint: ImageProcessingConstraint;
  update_columns?: Array<ImageProcessingUpdateColumn>;
  where?: InputMaybe<ImageProcessingBoolExp>;
};

/** Ordering options when selecting data from "image_processing". */
export type ImageProcessingOrderBy = {
...
/** primary key columns input for table: image_processing */
export type ImageProcessingPkColumnsInput = {
  id: Scalars['uuid'];
};

/** select columns of table "image_processing" */
export enum ImageProcessingSelectColumn {
  /** column name */
...
/** input type for updating data in table "image_processing" */
export type ImageProcessingSetInput = {
  created_at?: InputMaybe<Scalars['timestamptz']>;
  file_id?: InputMaybe<Scalars['uuid']>;
  id?: InputMaybe<Scalars['uuid']>;
  message?: InputMaybe<Scalars['String']>;
...
/** aggregate stddev on columns */
export type ImageProcessingStddevFields = {
  __typename?: 'image_processing_stddev_fields';
  status?: Maybe<Scalars['Float']>;
};

/** aggregate stddev_pop on columns */
export type ImageProcessingStddevPopFields = {
  __typename?: 'image_processing_stddev_pop_fields';
  status?: Maybe<Scalars['Float']>;
};

/** aggregate stddev_samp on columns */
export type ImageProcessingStddevSampFields = {
  __typename?: 'image_processing_stddev_samp_fields';
  status?: Maybe<Scalars['Float']>;
};

/** aggregate sum on columns */
export type ImageProcessingSumFields = {
  __typename?: 'image_processing_sum_fields';
  status?: Maybe<Scalars['Int']>;
};

/** update columns of table "image_processing" */
export enum ImageProcessingUpdateColumn {
  /** column name */
  CreatedAt = 'created_at',
  /** column name */
  FileId = 'file_id',
...
export type ImageProcessingUpdates = {
  /** increments the numeric columns with given value of the filtered values */
  _inc?: InputMaybe<ImageProcessingIncInput>;
  /** sets the columns of the filtered rows to the given values */
  _set?: InputMaybe<ImageProcessingSetInput>;
  where: ImageProcessingBoolExp;
};

/** aggregate var_pop on columns */
export type ImageProcessingVarPopFields = {
  __typename?: 'image_processing_var_pop_fields';
  status?: Maybe<Scalars['Float']>;
};

/** aggregate var_samp on columns */
export type ImageProcessingVarSampFields = {
  __typename?: 'image_processing_var_samp_fields';
  status?: Maybe<Scalars['Float']>;
};

/** aggregate variance on columns */
export type ImageProcessingVarianceFields = {
  __typename?: 'image_processing_variance_fields';
  status?: Maybe<Scalars['Float']>;
};
...
export type Measurement = {
  ...
  created_at?: Maybe<Scalars['timestamptz']>;
  id: Scalars['uuid'];
  image_processing_id: Scalars['uuid'];
...
export type MeasurementBoolExp = {
  ...
  created_at?: InputMaybe<TimestamptzComparisonExp>;
  id?: InputMaybe<UuidComparisonExp>;
  image_processing_id?: InputMaybe<UuidComparisonExp>;
...
export enum MeasurementConstraint {
  /** unique or primary key constraint on columns "id" */
  MeasurementPkey = 'measurement_pkey'
}
...
export type MeasurementInsertInput = {
  created_at?: InputMaybe<Scalars['timestamptz']>;
  id?: InputMaybe<Scalars['uuid']>;
  image_processing_id?: InputMaybe<Scalars['uuid']>;
...
export type MeasurementMaxFields = {
  ...
  created_at?: Maybe<Scalars['timestamptz']>;
  id?: Maybe<Scalars['uuid']>;
  image_processing_id?: Maybe<Scalars['uuid']>;
...
export type MeasurementOrderBy = {
  created_at?: InputMaybe<OrderBy>;
  id?: InputMaybe<OrderBy>;
  image_processing_id?: InputMaybe<OrderBy>;
...
export type MutationRoot = {
  ...
  /** delete data from the table: "image_processing" */
  delete_image_processing?: Maybe<ImageProcessingMutationResponse>;
  /** delete single row from the table: "image_processing" */
  delete_image_processing_by_pk?: Maybe<ImageProcessing>;
  ...
  /** insert data into the table: "image_processing" */
  insert_image_processing?: Maybe<ImageProcessingMutationResponse>;
  /** insert a single row into the table: "image_processing" */
  insert_image_processing_one?: Maybe<ImageProcessing>;
  ...
  /** update data of the table: "image_processing" */
  update_image_processing?: Maybe<ImageProcessingMutationResponse>;
  /** update single row of the table: "image_processing" */
  update_image_processing_by_pk?: Maybe<ImageProcessing>;
  /** update multiples rows of table: "image_processing" */
  update_image_processing_many?: Maybe<Array<Maybe<ImageProcessingMutationResponse>>>;
...
/** mutation root */
export type MutationRootDeleteImageProcessingArgs = {
  where: ImageProcessingBoolExp;
};


/** mutation root */
export type MutationRootDeleteImageProcessingByPkArgs = {
  id: Scalars['uuid'];
};
...
/** mutation root */
export type MutationRootInsertImageProcessingArgs = {
  objects: Array<ImageProcessingInsertInput>;
  on_conflict?: InputMaybe<ImageProcessingOnConflict>;
};


/** mutation root */
export type MutationRootInsertImageProcessingOneArgs = {
  object: ImageProcessingInsertInput;
  on_conflict?: InputMaybe<ImageProcessingOnConflict>;
};
...
/** mutation root */
export type MutationRootUpdateImageProcessingArgs = {
  _inc?: InputMaybe<ImageProcessingIncInput>;
  _set?: InputMaybe<ImageProcessingSetInput>;
  where: ImageProcessingBoolExp;
};
...
/** mutation root */
export type MutationRootUpdateImageProcessingByPkArgs = {
  _inc?: InputMaybe<ImageProcessingIncInput>;
  _set?: InputMaybe<ImageProcessingSetInput>;
  pk_columns: ImageProcessingPkColumnsInput;
};


/** mutation root */
export type MutationRootUpdateImageProcessingManyArgs = {
  updates: Array<ImageProcessingUpdates>;
};
...
export type QueryRoot = {
  ...
  /** fetch data from the table: "image_processing" */
  image_processing: Array<ImageProcessing>;
  /** fetch aggregated fields from the table: "image_processing" */
  image_processing_aggregate: ImageProcessingAggregate;
  /** fetch data from the table: "image_processing" using primary key columns */
  image_processing_by_pk?: Maybe<ImageProcessing>;
...
export type QueryRootImageProcessingArgs = {
  distinct_on?: InputMaybe<Array<ImageProcessingSelectColumn>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<ImageProcessingOrderBy>>;
  where?: InputMaybe<ImageProcessingBoolExp>;
};


export type QueryRootImageProcessingAggregateArgs = {
  distinct_on?: InputMaybe<Array<ImageProcessingSelectColumn>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<ImageProcessingOrderBy>>;
...
export type QueryRootImageProcessingByPkArgs = {
  id: Scalars['uuid'];
};
...
export type SubscriptionRootImageProcessingArgs = {
  distinct_on?: InputMaybe<Array<ImageProcessingSelectColumn>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<ImageProcessingOrderBy>>;
...
export type SubscriptionRootImageProcessingAggregateArgs = {
  distinct_on?: InputMaybe<Array<ImageProcessingSelectColumn>>;
  limit?: InputMaybe<Scalars['Int']>;
  offset?: InputMaybe<Scalars['Int']>;
  order_by?: InputMaybe<Array<ImageProcessingOrderBy>>;
...
export type SubscriptionRootImageProcessingByPkArgs = {
  id: Scalars['uuid'];
};
...
export type InsertImageProcessingMutationVariables = Exact<{
  fileId: Scalars['uuid'];
  status: Scalars['Int'];
  message?: InputMaybe<Scalars['String']>;
}>;
...
export type InsertImageProcessingMutation = { __typename?: 'mutation_root', result?: { __typename?: 'image_processing', id: any } | null };

export type InsertMeasurementMutationVariables = Exact<{
  imageProcessingId: Scalars['uuid'];
  value: Scalars['float8'];
  time?: InputMaybe<Scalars['timestamptz']>;
}>;
...
export const InsertImageProcessingDocument = gql`
  ...
  result: insert_image_processing_one(
    ...
    `;
export const InsertMeasurementDocument = gql`
    mutation insertMeasurement($imageProcessingId: uuid!, $value: float8!, $time: timestamptz) {
  result: insert_measurement_one(
    object: {image_processing_id: $imageProcessingId, value: $value, time: $time}
  ) {
    id
  }
}
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    insertImageProcessing(variables: InsertImageProcessingMutationVariables, requestHeaders?: Dom.RequestInit["headers"]): Promise<InsertImageProcessingMutation> {
      return withWrapper((wrappedRequestHeaders) => client.request<InsertImageProcessingMutation>(InsertImageProcessingDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'insertImageProcessing', 'mutation');
    },
